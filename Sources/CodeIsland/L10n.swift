...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "ai_reply_lines_desc": "Capped replies show a clean text preview; Unlimited renders full Markdown — lists, tables and code blocks",
        "copy_code": "Copy code",
    ...
    private static let de: [String: String] = en.merging([
        ...
        "ai_reply_lines_desc": "Mit Zeilenlimit erscheint eine bereinigte Textvorschau; „Unbegrenzt“ zeigt das vollständige Markdown – Listen, Tabellen und Codeblöcke",
    ...
    private static let zh: [String: String] = [
        ...
        "ai_reply_lines_desc": "限制行数时显示去掉 Markdown 标记的纯文本预览；选“不限制”则完整渲染列表、表格和代码块",
        "copy_code": "复制代码",
    ...
    private static let zhHant: [String: String] = [
        ...
        "ai_reply_lines_desc": "限制行數時顯示去除 Markdown 標記的純文字預覽；選「不限制」則完整呈現清單、表格與程式碼區塊",
        "copy_code": "複製程式碼",
    ...
    private static let ja: [String: String] = [
        ...
        "ai_reply_lines_desc": "行数を制限すると Markdown 記号を除いたテキストでプレビューし、「無制限」ではリスト・表・コードブロックまで描画します",
        "copy_code": "コードをコピー",
    ...
    private static let ko: [String: String] = [
        ...
        "ai_reply_lines_desc": "줄 수를 제한하면 Markdown 기호를 뺀 깔끔한 텍스트로 미리 보고, '제한 없음'이면 목록·표·코드 블록까지 렌더링합니다",
        "copy_code": "코드 복사",
    ...
    private static let tr: [String: String] = [
        ...
        "ai_reply_lines_desc": "Satır sınırı temiz bir metin önizlemesi gösterir; Sınırsız seçeneği listeler, tablolar ve kod bloklarıyla tam Markdown işler",
